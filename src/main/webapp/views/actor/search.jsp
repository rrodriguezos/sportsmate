...
<h1><spring:message code="actor.users"/></h1>
...
<h1><spring:message code="actor.customers"/></h1>
<display:table name="customers" id="row" requestURI="customer/search.do" 
	...
	<spring:message code="customer.provinceCenter" var="provinceCenterHeader"/>		   
	<display:column property="provinceCenter" title="${provinceCenterHeader}" />
