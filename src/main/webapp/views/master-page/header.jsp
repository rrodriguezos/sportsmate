		...
		<ul class='nav navbar-nav collapse navbar-collapse'>
			...
			<security:authorize access="hasRole('USER')">
				<li><a href='#' data-toggle='dropdown'> <spring:message
					...
					<ul class='dropdown-menu'>
						...
						<li><a href="tournament/listAll.do"><spring:message
									code="master.page.actor.all.tournaments" /></a></li>
						<li><a href="tournament/user/list.do"><spring:message
									code="master.page.actor.list.tournaments" /></a></li>
						<li><a href="tournament/user/create.do"><spring:message
									code="master.page.actor.create.tournaments" /></a></li>
						<li><a href="tournament/user/rounds/list.do"><spring:message
									code="master.page.user.manageTournaments" /></a></li>
					</ul></li>
			</security:authorize>
			...
			<security:authorize access="hasRole('CUSTOMER')">
				<li><a href='#' data-toggle='dropdown'> <spring:message
					...
					<ul class='dropdown-menu'>
						<li><a href="tournament/customer/list.do"><spring:message
									code="master.page.actor.list.tournaments" /></a></li>
						<li><a href="tournament/customer/create.do"><spring:message
									code="master.page.actor.create.tournaments" /></a></li>
						<li><a href="tournament/listAll.do"><spring:message
									code="master.page.actor.all.tournaments" /></a></li>
						<li><a href="tournament/user/rounds/list.do"><spring:message
			...
			<security:authorize access="isAnonymous()">
				...
				<li><a href='#' data-toggle='dropdown'> <spring:message
							code="master.page.register" /> <span class='caret'></span>
				</a>
					<ul class='dropdown-menu'>
			...
			<li>
				<form class="navbar-form navbar-right">
					<div class="input-group">
						<input type="text" class="form-control spm-search-input"
							id="idsearch" onkeypress="hidSearch(event);"> <span
							class="input-group-btn">
							<button class="btn btn-default spm-search-button" type="button"
								onclick="search()">
