...
<b><spring:message code="tournament.startMoment" />: </b> 
	<fmt:formatDate value="${tournament.startMoment}" pattern="dd/MM/yyyy HH:mm"/>	
<br/>

<b><spring:message code="tournament.finishMoment" />: </b> 
	<fmt:formatDate value="${tournament.finishMoment}" pattern="dd/MM/yyyy HH:mm"/>	
<br/>
...
<h1><spring:message code="tournament.teams"/></h1>
...
<h1><spring:message code="tournament.matches"/></h1>
